...
export default function SlideoutNavbar()
{
    ...
    return (
        <div className={ComponentStyles.navigation}>
            <div className={ComponentStyles.navbar}>
                <div 
                    className={`${ComponentStyles.hamburger} ${isNavbarOpen ? ComponentStyles.hamburgerOpen : ''}`}
            ...
            <div 
                className={`${ComponentStyles.menu} ${isNavbarOpen ? ComponentStyles.menuOpen : ''}`}
            >
                <Link href="/">
